namespace Terminal
{
    partial class NetworkErrorForm
	{
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.label1.Text = "Сервис временно не доступен";
			...
			this.Name = "NetworkErrorForm";
			this.Text = "NetworkErrorForm";
			this.Shown += new System.EventHandler(this.NetworkErrorForm_Shown);
